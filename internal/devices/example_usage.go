...
func ExampleWithSpecificType() {
	...
	ctx := context.Background()
	parsed, err := registry.ParseWithType(ctx, rawPayload, DeviceTypeRAK2270)
	if err != nil {
...
func processDeviceData(data *ParsedData) error {
	// Here you would:
...
func ExampleErrorHandling(registry *Registry, rawPayload *RawPayload) {
	ctx := context.Background()
