...
type MessageProcessor struct {
	detector *devices.IdentifierDetector
	registry *Registry
}
...
func NewMessageProcessor(registry *Registry) *MessageProcessor {
	return &MessageProcessor{
		detector: devices.NewIdentifierDetector(),
		registry: registry,
	}
}
...
func (mp *MessageProcessor) findDevice(ctx context.Context, orgSlug string, identifiers []devices.DeviceIdentifier) (*devices.DeviceEntry, string, string, error) {
...
func (mp *MessageProcessor) determinePrimaryID(foundIdentifier devices.DeviceIdentifier, device *devices.DeviceEntry) string {
...
func (mp *MessageProcessor) handleUnknownDevice(ctx context.Context, orgSlug string, identifiers []devices.DeviceIdentifier, payload, locationPayload map[string]interface{}) (*ProcessingContext, error) {
...
func (mp *MessageProcessor) findBestIdentifierForAPI(identifiers []devices.DeviceIdentifier) (string, string) {
...
func (mp *MessageProcessor) createProcessingContext(ctx context.Context, orgSlug string, identifiers []devices.DeviceIdentifier, device *devices.DeviceEntry, primaryID, protocolType string) (*ProcessingContext, error) {
...
func (mp *MessageProcessor) DetermineDeviceType(identifiers []devices.DeviceIdentifier, payload map[string]interface{}) devices.DeviceType {
	...
	return devices.DeviceTypeUnknown
}
