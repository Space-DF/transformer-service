...
func (p *TBeamComponent) ParsePayload(payload *common.RawPayload) (*common.ParsedData, error) {
...
func (p *TBeamComponent) ParseToEntities(orgSlug, model string, payload *common.RawPayload, deviceLocation *common.Location) ([]common.Entity, error) {
	devEUI := payload.DeviceEUI
	if devEUI == "" {
		devEUI = lns.ExtractDevEUI(payload.Metadata, payload.LNSType)
	}
